...
function logger(opt) {
    ...
    optional.maxFiles = Number(optional.maxFiles) || null, optional.json = optional.json === !1 ? !1 : !0, 
    optional.raw = optional.raw === !1 ? !1 : !0, my.logger = optional.logger;
    var log = new winston.Logger();
    my.filename && (optional.filename = require("path").resolve(String(my.filename)), 
    log.add(winston.transports.File, optional)), Boolean(options.console) && log.add(winston.transports.Console, optional);
